...
// sichern der Higshcore Werte
    if ( highscore[SNAKE] > settings.mySettings.highscore[SNAKE] || highscore[TETRIS] > settings.mySettings.highscore[TETRIS] || highscore[BRICKS] > settings.mySettings.highscore[BRICKS] ) 
    {
#ifdef DEBUG_GAME
  Serial.println(F("sichere Highscore in NVS"));
#endif
